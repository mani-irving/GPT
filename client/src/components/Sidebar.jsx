  ...
  return (
    <div
      className={`flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30
        border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-wd:absolute left-0 z-1 ${
    ...
    >
      ...
      <button
        ...
        bg-gradient-to-r from from-[#A456F7] to-[#3D81F6] text-sm rounded-md cursor-pointer"
      >
          ...
          .map((chat) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-[#B1A6C01]">
